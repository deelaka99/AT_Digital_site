  ...
  return (
    <div className="w-full mobile:h-[180vh] tablet:h-[80vh] laptop:h-[150vh] laptop:px-28">
      ...
      <div className="bg-white w-full mobile:h-[90vh] tablet:h-[40vh] laptop:h-[75vh] tablet:flex tablet:px-7 laptop:px-0">
        {/* for PC image */}
        <div className="mobile:w-full mobile:h-[30vh] tablet:h-full tablet:w-2/5 laptop:w-1/3 mobile:px-2 mobile:py-2 flex items-center justify-center">
          <img src={PC} alt="PC" className="mobile:w-2/3 tablet:w-full" />
        </div>
        {/* for web & mobile app development part */}
        <div className="mobile:w-full mobile:h-[60vh] tablet:h-full tablet:w-3/5 laptop:w-2/3 flex flex-col mobile:items-center tablet:items-start justify-center mobile:px-3 mobile:py-2">
          <h1 className="mobile:text-center tablet:text-start font-poppins font-bold text-primary mobile:text-[27px] tablet:text-[30px] laptop:text-[34px] tablet:leading-[1.2]">
            Web & Mobile App Development
          </h1>
          <br />
          <p className="mobile:text-center tablet:text-start font-medium font-inter text-txtColor mobile:text-[16px] mobile:leading-[1.2] tablet:text-[20px] laptop:text-[23px] tablet:leading-[1.2]">
      ...
      <div className="w-full mobile:h-[90vh] tablet:h-[40vh] laptop:h-[75vh] tablet:flex tablet:px-7 laptop:px-0">
        {/* for magnifier image */}
        <div className="mobile:w-full mobile:h-[35vh] tablet:h-full tablet:w-3/5 mobile:px-2 laptop:pl-0 mobile:py-2 flex tablet:flex-col mobile:flex-row mobile:items-center tablet:items-start justify-center">
          {/* for mobiles */}
          <img
            src={Magnifier}
            alt="Magnifier"
          ...
          />
          {/* for tablet onwards */}
          <h1 className="mobile:hidden tablet:block tablet:text-start font-poppins font-semibold text-primary tablet:text-[30px] laptop:text-[34px] tablet:leading-[1.2]">
            Digital Strategy Consulting
          </h1>
          <br />
          <p className="mobile:hidden tablet:block tablet:text-start font-medium font-inter text-txtColor tablet:text-[20px] laptop:text-[23px] tablet:leading-[1.2]">
        ...
        <div className="mobile:w-full mobile:h-[55vh] tablet:h-full tablet:w-2/5 flex mobile:flex-col tablet:flex-row items-center justify-center mobile:px-3 mobile:py-2">
          ...
          <br />
          <button className="tablet:hidden bg-secondary text-center font-inter font-semibold mobile:text-[14px] text-accent1 mobile:py-3 mobile:px-6 laptop:pr-0 rounded shadow-md active:bg-txtColorLight">
            LEARN MORE
          </button>
          {/* for tablets onward */}
          <img
